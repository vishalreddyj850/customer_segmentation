...
subtitle: "Customer Segmentation for E-commerce"
author: "Vishal Reddy Jakkareddy & PruthviRaj Amgoth (Advisor: Dr. Cohen)"
date: '`r Sys.Date()`'
format:
  revealjs:
    theme: default
...
- K-Means clustering is favored for its efficiency and ease of implementation [@paramita2024comparison].
...
<center>
<img src="kmeans_step1.png">
<p style="font-size: small; text-align: center;">Initialize Cluster Centers (Image Source: <a href="https://medium.com/@sygong/k-means-clustering-for-customer-segmentations-a-practical-real-world-example-196a10323b9f" target="_blank">Shiyu Gong</a>)</p>
</center>
...
<center>
<img src="kmeans_step2.png">
<p style="font-size: small; text-align: center;">Assign Data Points (Image Source: <a href="https://medium.com/@sygong/k-means-clustering-for-customer-segmentations-a-practical-real-world-example-196a10323b9f" target="_blank">Shiyu Gong</a>)</p>
</center>
...
<center>
<img src="kmeans_step3.png">
<p style="font-size: small; text-align: center;">Update Cluster Centers (Image Source: <a href="https://medium.com/@sygong/k-means-clustering-for-customer-segmentations-a-practical-real-world-example-196a10323b9f" target="_blank">Shiyu Gong</a>)</p>
</center>
...
<center>
<img src="kmeans_step4.png">
<p style="font-size: small; text-align: center;">Repeat Until Convergence (Image Source: <a href="https://medium.com/@sygong/k-means-clustering-for-customer-segmentations-a-practical-real-world-example-196a10323b9f" target="_blank">Shiyu Gong</a>)</p>
</center>
...
$$
\text{WCSS} = \sum_{x_k \in Z_1^{(I)}} \text{distance}(x_k^{(j)}, z_1^{(I)})^2
+ \sum_{x_k \in Z_2^{(I)}} \text{distance}(x_k^{(j)}, z_2^{(I)})^2
+ \sum_{x_k \in Z_3^{(I)}} \text{distance}(x_k^{(j)}, z_3^{(I)})^2
+ \cdots
$$
...
<center>
<img src="elbow_method.webp">
<p style="font-size: small; text-align: center;">Elbow Method (Image Source: <a href="https://medium.com/analytics-vidhya/an-unsupervised-scenario-with-k-means-algorithm-5312fee552b8" target="_blank">Soumo Chatterjee</a>)</p>
</center>
---
...
<small>Dim1 and Dim2 are principal components resulting from a dimensionality reduction technique</small>
